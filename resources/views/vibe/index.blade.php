 ...
 <main class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8 hover-scale">
        <div class="flex items-center space-x-6">
            ...
            <button class="ml-auto bg-indigo-600 text-white px-6 py-2.5 rounded-lg hover:bg-indigo-700 transform transition hover:-translate-y-0.5 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Edit Profile
            </button>
        </div>
    </div>
