        ...
        <div class="h-64 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-b-lg relative">
            <div class="absolute -bottom-16 left-8 flex items-end space-x-6">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-indigo-600"><spcan>@</spcan>{{$User->nickname}}</p>
                </div>
            </div>
            <!-- Edit Profile Button -->
            <div class="absolute bottom-4 right-8">
                <a href="profile-edit.html"
                   class="bg-white text-indigo-600 px-6 py-2.5 rounded-lg hover:bg-indigo-50 transition shadow-md
